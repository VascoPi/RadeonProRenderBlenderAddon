...
class RPR_RenderProperties(RPR_Properties):
    ...
    viewport_upscale_quality: EnumProperty(
        ...
        description="Viewport upscaler quality setting",
        items=(
            ('RPR_FSR2_QUALITY_ULTRA_QUALITY', "Ultra Quality", "Ultra Quality"),
            ('RPR_FSR2_QUALITY_MODE_QUALITY', "Quality", "Quality"),
            ('RPR_FSR2_QUALITY_MODE_BALANCE', "Balance", "Balance"),
            ('RPR_FSR2_QUALITY_MODE_PERFORMANCE', "Performance", "Performance"),
            ('RPR_FSR2_QUALITY_MODE_ULTRA_PERFORMANCE', "Ultra Performance", "Ultra Performance"),
        ),
        default='RPR_FSR2_QUALITY_MODE_BALANCE',
    )
